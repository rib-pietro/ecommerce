                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Subtotal</th>
                                                <td><span class="amount">R$<?php if( $cart["vlsubtotal"] != NULL ){ ?><?php echo formatPrice($cart["vlsubtotal"]); ?><?php }else{ ?>0,00<?php } ?></span></td>
                                            </tr>

                                            <tr class="shipping">
                                                <th>Frete</th>
                                                <td>R$<?php if( $cart["vlfreight"] != NULL ){ ?><?php echo formatPrice($cart["vlfreight"]); ?><?php }else{ ?>0,00<?php } ?> <?php if( $cart["nrdays"] > 0 ){ ?> <small>prazo de <?php echo htmlspecialchars( $cart["nrdays"], ENT_COMPAT, 'UTF-8', FALSE ); ?> dia(s)</small> <?php } ?></td>
                                            </tr>
