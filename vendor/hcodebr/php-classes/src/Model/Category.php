...
class Category extends Model{
	...
	public static function updateFile()
	{
		...
		file_put_contents($_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "views" . DIRECTORY_SEPARATOR . "categories-menu.html", implode('', $html)); //escreve no arquivo todo o conteúdo do array html transformado numa string
